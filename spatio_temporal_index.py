...
class SpatioTemporalDatabase:
    ...
    def init_static_info(self, road_network):
        ...
        print("Computing the grid distance matrix (about 40 sec)...")
        start_time = time.clock()
        #self.__compute_distance_matrix(road_network)
    ...
    def __construct_static_list(self):
        ...
        for i in self.grid:
            ...
            # temporal grid list
            temporal_list = {key: value.t*7.0/AVERAGE_SPEED for key, value in self.grid_distance_matrix[i].items()}
