...
NUM_TAXI = 33000      # the number of taxis
AVERAGE_SPEED = 15.0    # average speed of taxis, unit: m/s (7 m/s = 25.2 km/h)
TAXI_CAPACITY = 4    # maximum number of passengers that a taxi can hold
