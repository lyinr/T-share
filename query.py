...
from constants import PRECISION, PATIENCE, WAITING, CANCELLED, MAX_INT, SIM_START_TIME, SIM_END_TIME, AVERAGE_SPEED
...
class Query:
    ...
    def __init__(self, identifier, timestamp, origin, destination,
        ...
        self.delivery_window = TimeWindow(timestamp, timestamp + expected_travel_time + PATIENCE)  # @type delivery_window: TimeWindow
...
def init_schedule_node(query_queue, road_network, database):
    ...
    #To map query location to vertex of road_network
